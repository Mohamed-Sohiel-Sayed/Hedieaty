...
$testDirectory = "D:\ASU\Fall24\00.Mobileprogramming\new\hedieaty\test"
$projectDirectory = "D:\ASU\Fall24\00.Mobileprogramming\new\hedieaty"
...
$flutterProcess = Start-Process flutter -ArgumentList "test", -RedirectStandardOutput $flutterLogFile -PassThru -NoNewWindow
